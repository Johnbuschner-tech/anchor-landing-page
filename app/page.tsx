...
const FEATURES = [
  ...
  { icon: BookOpen,    title: "Skills Library",          desc: "29 evidence-based techniques organized by Body, Mind, Spirit, Social, and Crisis — each with clinical context.",      tag: "Learn & Practice",  color: "teal"  },
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <motion.div className="space-y-8" initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.9, ease: [0.22, 1, 0.36, 1] }}>
              ...
              <p className="text-lg leading-relaxed max-w-md" style={{ color: "#64748b" }}>
                41 evidence-based coping skills for addiction recovery — breathing, grounding, urge surfing, and more. Free, private, and available the moment you need it most.
              </p>
